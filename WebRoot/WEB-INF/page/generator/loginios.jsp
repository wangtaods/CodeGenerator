...
<body>
 ...
 <div style="margin: 20px;">     
	...
	<table class="layui-table" lay-data="{ url:'/loginios/list', method:'post',  page:true, id:'listTable'}" lay-filter="list">
	  <thead>
	    <tr>
 ...
 <script src="/js/generator/loginios.js?<%=System.currentTimeMillis()%>"></script>  
</body>
</html>
