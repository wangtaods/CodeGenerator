...
public class GenUtils {
	...
	public static List<String> getTemplates() {
		...
		templates.add("template/T.java.vm");
		...
		templates.add("template/form_add.html.vm");
		templates.add("template/form_update.html.vm");
////		templates.add("template/list.jsp.vm");
	...
	public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip,
			boolean iszip, String projectPath, String packageName) {
		// 配置信息
		...
		map.put("module", packageName.substring(packageName.lastIndexOf(".") + 1));
		...
		for (String template : templates) {
			...
			if (iszip) {
				...
				try {
					// 添加到zip
					String fileName = getFileName(template, tableEntity.getClassName(), packageName);
					zip.putNextEntry(new ZipEntry(fileName));
					String string = sw.toString();
					if (fileName.endsWith(".html")) {
						string = string.replace("#&", "$");
						string = string.replace("</head>", "[#include \"/htmlpages/plugins.html\"/]\r\n" + "</head>");
					}
					IOUtils.write(string, zip, "UTF-8");
				...
				File file = new File(
						projectPath + File.separator + getFileName(template, tableEntity.getClassName(), packageName));
	...
	public static String getFileName(String template, String className, String packageName) {
		...
		if (template.contains("Entity.java.vm")) {
			return packagePath + "model" + File.separator + "base" + File.separator + className + "Entity.java";
		}
		if (template.contains("T.java.vm")) {
		...
		if (template.contains("list.jsp.vm")) {
			return WebRoot + File.separator + "WEB-INF" + File.separator + "jpspages" + File.separator
